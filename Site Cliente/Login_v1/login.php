		...
		<div class="container-login100">
			<div class="wrap-login100">
				<?php
					echo $texto;
				?>
				<form class="login100-form validate-form" action="login(V1).php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "E-mail invalido: Email@email.com">
