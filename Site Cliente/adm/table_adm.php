        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Administradores Ativos</div>
            <div class="card-body">
              <div class="card-title-block">
                <i class="fa fa-search" aria-hidden="true"></i>
                <input type="text" id="myInput1" onkeyup="pesquisaAdm()" placeholder="Procurar administrador...">
              </div>
              <div class="table-responsive">
                <table class="table table-bordered tb-adm" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Nome</th>
                  ...
                  <tbody>
                    <?php
                        ...
                        while ($consulta = mysqli_fetch_array($result)) {
                            ...
                            echo "<td><a href=update.php?id=$consulta[id]><i class='fas fa-fw fa-pencil-alt'></i></td>";
                            echo "</tr>";
                        }
                    ?>
                  </tbody>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>
              Administradores Inativos</div>
            <div class="card-body">
              <div class="card-title-block">
                <i class="fa fa-search" aria-hidden="true"></i>
                <input type="text" id="myInput2" onkeyup="pesquisaInactive()" placeholder="Procurar administrador inativo...">
              </div>
              <div class="table-responsive">
                <table class="table table-bordered tb-adm" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                  ...
                  <tbody>
                    <?php
                        include("../php/conecta.php");
                        $sql = "SELECT * FROM tb_adm WHERE ativo='false'";
