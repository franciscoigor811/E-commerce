            ...
            <div class="card-header">
              ...
              <?php
                if(!isset($_POST['id'])) {
                  ...
                  redirect("table_vendas.php");
                } else {
                  $id = $_POST['id'];
                  echo "Detalhes da Venda #".$id."</div>";
                }
              ?>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table_msg" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    $sql = "SELECT tb_produto.nome,tb_produtovenda.quantidade,tb_produtovenda.valor
                            FROM tb_produtovenda
                            INNER JOIN tb_produto ON tb_produtovenda.idproduto=tb_produto.id
                            WHERE tb_produtovenda.id='$id'";
                    ...
                    while ($consulta = mysqli_fetch_array($result)) {
                      if(mysqli_num_rows($result) > 0) {
                        ...
                        echo "<td>$consulta[quantidade]</td>";
