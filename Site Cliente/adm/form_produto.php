      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            ?>
            <a class="dropdown-item active" href="form_produto.php">Produto</a>
          </div>
        </li>
      </ul>
       ...
       <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Formulário de produto</li>
          </ol>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Formulário de Produto</div>
            <div class="card-body">
              <form method="post" action="../php/insert_produto.php" enctype="multipart/form-data">
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-md-10">
                      <div>
                        <input class="form-control form-control-lg" name="nome" type="text" placeholder="Nome">
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div>
                        <div class="input-group mb-2">
                          ...
                          <input name='valor' class="form-control form-control-lg" type="number" min="0" max="200" step="any">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-md-12">
                      <input class="form-control form-control-lg" type="text" name="unidade" placeholder="Unidade">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-primary btn-block" type="submit" id="botão" name="botão" value="Enviar">Registrar</a>
              </form>
            </div>
          </div>
        </div>
