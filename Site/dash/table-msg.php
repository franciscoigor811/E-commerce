...
<head>
  ...
  <title> Fran Sistemas - Tabela de Mensagens </title>
  ...
  <div class="main-wrapper">
              ...
              <nav class="menu">
                <ul class="nav metismenu" id="sidebar-menu">
                  ...
                  <ul>
                    ...
                    ?>
                    <li class="active"> <a href="table-msg.php">
                      Mensagens
                    </a> </li>
                  </ul>
                </li>
   ...
   <article class="content responsive-tables-page">
    <div class="title-block">
      <h1 class="title"> Tabela de Mensagens </h1>
      <p class="title-description"> Mensagens enviadas a partir do site aparecerão aqui. </p>
    </div>
          ...
          <div class="card">
            <div class="card-block">
              <div class="card-title-block">
                <h3 class="title"> Mensagens Recebidas </h3>
                <i class="fa fa-search" aria-hidden="true"></i>
                <input type="text" id="myInput" onkeyup="pesquisaMsg()" placeholder="Procurar mensagem...">
              </div>
              <section class="example">
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover" id="tb-msg">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Nome</th>
